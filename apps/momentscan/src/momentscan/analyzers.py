...
ANALYZERS: tuple[Analyzer, ...] = (
    ...
    Analyzer("scene", "stage", "DINOv3", ("frames", "tubelets"),
             ...
             "node: stages/scene.py → backend: plugins/features-specialist45d (isolated)", needs_source=True),
    Analyzer("features", "stage", "HSEmotion + LibreFace + MediaPipe + DPR-SH + pixel", ("tubelets",),
             ...
             "node: stages/features.py → backend: plugins/features-specialist45d (isolated)", needs_source=True),
