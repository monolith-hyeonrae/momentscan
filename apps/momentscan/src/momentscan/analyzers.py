...
ANALYZERS: tuple[Analyzer, ...] = (
    ...
    Analyzer("scene", "stage", "DINOv3", ("frames", "tubelets"),
             "embedding", ("cls", "customer_embedding", "bg_embedding"), "scene.parquet", ("tubelets",), needs_source=True),
    Analyzer("features", "stage", "HSEmotion + LibreFace + MediaPipe + DPR-SH + pixel", ("tubelets",),
             "timeline", ("registry.py FIELDS (67D)",), "features.parquet", ("tubelets",), needs_source=True),
