...
**측정된 부정 결과 (재구축 금지, 2026-07-02)**: 3축 불일치(|Δpitch|+|Δroll|) 신뢰도 가드는
판별력 없음 — 오일러 crosstalk가 **정품 극단 포즈**(고개 젖힌 웃음, d3 47–74)에서 후드 환각(39–83)과
완전 겹침 + 절대 τ는 클립횡단 실패(클립별 med 14–39) + 유일 누수(dual_2 3프레임)는 배달물 미도달.
증거: output/l2/corrob_band_spotcheck.png · test0_hid3_spotcheck.png. 새 실패 사례 없이 재시도 금지;
재발 시 후보 = per-frame 임계가 아니라 **track-수준 MP↔6D 정합 신뢰도**.
